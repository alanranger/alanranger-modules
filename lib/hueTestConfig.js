  ...
  return Array.from({ length: count }, (_, idx) => {
    ...
    const hue =
      (spec.hueStart +
        ...
        HUE_JITTER[idx]) %
      360;
    const hueValue = Number(hue.toFixed(3));
    const hex = rgbToHex(oklchToRgb({ L: spec.L, C: spec.C, h: hueValue }));
    return {
      id: `${spec.id}-${idx + 1}`,
      hex,
      hue: hueValue,
  ...
  thresholds: [
    {
      ...
      detail: "Heavy hue ordering errors across rows."
    },
    {
      maxScore: 18,
      label: "Critical",
      detail: "Severe hue confusion; results are unreliable."
    },
    {
      maxScore: 28,
      label: "Severe",
      detail: "Large hue ordering gaps; retest in neutral light."
    },
    {
      maxScore: 38,
      label: "Very poor",
      detail: "Substantial hue ordering mistakes across rows."
    },
    {
      maxScore: 48,
      label: "Poor",
      detail: "Frequent hue swaps; use stronger references."
    },
    {
      maxScore: 58,
    ...
    },
    {
      maxScore: 68,
      label: "Below average",
      detail: "Regular hue confusion; work slowly and double-check."
    },
    {
      maxScore: 78,
      label: "Fair",
    ...
    },
    {
      maxScore: 88,
      label: "Good",
      detail: "Solid hue perception with several swaps."
    },
    {
      maxScore: 93,
      label: "Very good",
      detail: "Strong hue perception with a few swaps."
    },
    {
      maxScore: 98,
      label: "Excellent",
      detail: "Very strong hue ordering with minimal drift."
    },
    {
      maxScore: Infinity,
      label: "Perfect",
      detail: "Near-flawless hue ordering across all rows."
    }
  ]
};
