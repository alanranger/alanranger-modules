const ROW_SPECS = [
  { id: "r1", hueStart: 15, hueEnd: 60, L: 0.72, C: 0.12 },
  { id: "r2", hueStart: 95, hueEnd: 150, L: 0.72, C: 0.12 },
  { id: "r3", hueStart: 180, hueEnd: 235, L: 0.72, C: 0.12 },
  { id: "r4", hueStart: 270, hueEnd: 330, L: 0.72, C: 0.12 }
];

const HUE_JITTER = [-2, 1, -1, 2, 0, -2, 1, -1, 2, 0];
...
function buildRow(spec, rowIndex) {
  const count = 10;
  const step = (spec.hueEnd - spec.hueStart) / (count - 1);
  return Array.from({ length: count }, (_, idx) => {
    const hue = (spec.hueStart + step * idx + HUE_JITTER[idx]) % 360;
