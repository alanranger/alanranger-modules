...
function buildPersonalUpgradeUrl(memberId, email, windowExpiresAtMs) {
  ...
  // Route via server redirect so Memberstack login gating cannot strip the token
  // (same hop as trial-expiry-reminder emails — see api/academy/reengage-redirect.js).
