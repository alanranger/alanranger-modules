...
function sanitizeReengageToken(raw) {
  let token = String(raw || "").trim();
  // Email clients sometimes append markdown link closers to auto-detected URLs.
...
function verifyReengageToken(token) {
  ...
  token = sanitizeReengageToken(token);
