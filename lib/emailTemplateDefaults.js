...
const MERGE_TAG_DOCS = Object.freeze([
  ...
  { tag: "nextModuleTitle", desc: "Title of the next unopened foundation module." },
  { tag: "nextModuleUrl", desc: "Full URL of the next unopened foundation module." },
...
So if you haven't opened your first lesson yet, no worries at all. Here's the perfect place to begin:

**[→ Start with Module 1: Exposure]({{nextModuleUrl}})**

It takes about 10 minutes, and by the end you'll understand the single most important setting on your camera. That's your first rung on the ladder — and the Academy guides you from there, one step at a time.
...
Here's your next step, ready when you are:

**[→ Continue with {{nextModuleTitle}}]({{nextModuleUrl}})**
...
The easiest way back in is your next step:
...
I know life fills up, and sometimes the things we care about get crowded out for a bit — that's completely normal. But I'd hate for you to drift away from your photography when you've already invested in getting better at it. Everything you've built is still here, exactly where you left it.

If it's been a while since you looked, you might find a few things have moved on: the Academy now works as a proper coached path — it shows you what to do next, tracks your progress, and you earn badges as you work your way from the foundations through to mastering your camera. It's designed so you're never left wondering what to do next.

Here's an easy way back in — your next step is ready:

**[→ Pick up with {{nextModuleTitle}}]({{nextModuleUrl}})**

And if something's stopped you — the content isn't landing, you're not sure what to do next, you've hit a wall with your camera, or life's just been busy — **I'd really like to know.** Just reply and tell me. I read every message myself, and I'm glad to help you find your way back in.
