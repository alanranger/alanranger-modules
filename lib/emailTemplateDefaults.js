...
**[→ Come back & save with {{couponCode}}]({{upgradeUrl}})** — the discount's already applied, nothing to type in.

Or look around first: **[open your dashboard]({{dashboardUrl}})**.
...
**[→ Pick up where you left off with {{couponCode}}]({{upgradeUrl}})** — discount already applied.

Or take a look first: **[open your dashboard]({{dashboardUrl}})**.
...
**[→ Come back before the offer closes]({{upgradeUrl}})** — {{couponCode}} already applied.
...
**[→ Come back one last time with {{couponCode}}]({{upgradeUrl}})** — discount already applied.

Or take a final look: **[open your dashboard]({{dashboardUrl}})**.
