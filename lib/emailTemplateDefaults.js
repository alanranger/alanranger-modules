...
const MERGE_TAG_DOCS = Object.freeze([
  ...
  { tag: "modulesToNextBadge", desc: "Modules still needed for the next badge gate." },
...
const PLACEHOLDER_TRIAL_WELCOME = `
Hi {{firstName}},

[PLACEHOLDER — Branch A: 0 modules opened · trial day {{trialDayNumber}}]

Your first 10 minutes in the Academy start here: **{{nextModuleTitle}}**
...
const PLACEHOLDER_TRIAL_PROGRESS = `
Hi {{firstName}},

[PLACEHOLDER — Branch B/C: {{modulesOpened}} module(s) opened · {{daysSinceLastLogin}} day(s) since last login]

You're **{{modulesToNextBadge}} module(s)** from **{{nextBadge}}**. Your next step:
...
const DEFAULTS = Object.freeze({
  [STAGE_KEYS.TRIAL_WELCOME_NUDGE]: Object.freeze({
    ...
    subject: "[PLACEHOLDER] Your first 10 minutes in the Academy",
    body_md: PLACEHOLDER_TRIAL_WELCOME,
  }),
  [STAGE_KEYS.TRIAL_PROGRESS_NUDGE]: Object.freeze({
    label: "Trial progress nudge",
    subject: "[PLACEHOLDER] Great start — here's your next step",
    body_md: PLACEHOLDER_TRIAL_PROGRESS,
  }),
  [STAGE_KEYS.TRIAL_STALLED]: Object.freeze({
    label: "Trial stalled",
    subject: "[PLACEHOLDER] Pick up at {{nextModuleTitle}}",
