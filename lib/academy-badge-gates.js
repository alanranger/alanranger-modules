...
const JOURNEY_STAGES = [
  ...
  { key: "foundation", label: "Foundation", sublabel: "Open Exposure + 2 modules, 3 active days", iconClass: "ti-camera", colour: "green", stars: 1, foundationGate: true },
  { key: "practitioner", label: "Practitioner", sublabel: "10 camera + 5 composition modules, 3 assignments, 6+4 exams", iconClass: "ti-aperture", colour: "green", stars: 2, practitionerGate: true },
  { key: "certified", label: "Certified", sublabel: "All exams + modules, practice & applied work", iconClass: "ti-certificate", colour: "green", stars: 3, certifiedGate: true },
  { key: "graduate", label: "Graduate", sublabel: "Sustained breadth + 6 active months", iconClass: "ti-award", colour: "green", stars: 4, graduateGate: true },
  { key: "master", label: "Master", sublabel: "Deep breadth + 12 active months", iconClass: "ti-trophy", colour: "gold", stars: 5, masterGate: true },
];
...
function isCertifiedGateEarned(stats, hasConverted) {
...
function isStageConditionsMet(stage, stats, activeDays, engagementDegraded, gateContext) {
  ...
  if (stage.certifiedGate) return isCertifiedGateEarned(safeStats, hasConverted);
...
function buildBadgeRequirementsMatrix(stats, gateContext) {
  ...
  return [
    ...
    },
    {
      ...
      certified: { text: "✓", met: hasConverted },
