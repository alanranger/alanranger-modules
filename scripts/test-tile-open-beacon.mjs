...
import { DASHBOARD_SNIPPET, STRIP_SNIPPET } from "./snippet-paths.mjs";
...
const dashboardSnippet = fs.readFileSync(DASHBOARD_SNIPPET, "utf8");
const stripSnippet = fs.readFileSync(STRIP_SNIPPET, "utf8");
