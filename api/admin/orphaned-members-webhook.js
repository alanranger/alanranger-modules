...
async function getOrphanedMembers() {
  ...
  try {
    ...
    console.log(`[orphaned-webhook] Found ${orphanedMembers.length} orphaned members (no active plans)`);
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Return data in format that Zapier can easily process
    // Zapier will call this endpoint every 2 hours and process each member
